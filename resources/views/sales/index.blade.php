            ...
            <div class="bg-white overflow-hidden shadow rounded-lg">
                <div class="p-5">
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                <dt class="text-sm font-medium text-gray-500 truncate">Cash Sales</dt>
                                <dd class="text-lg font-medium text-gray-900">{{ $stats['cash_sales'] }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white overflow-hidden shadow rounded-lg">
                <div class="p-5">
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                <dt class="text-sm font-medium text-gray-500 truncate">Installment Sales</dt>
                                <dd class="text-lg font-medium text-gray-900">{{ $stats['installment_sales'] }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
            ...
            <form method="GET" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4">
                ...
                <div>
                    ...
                    <select name="payment_method" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        ...
                        <option value="home_credit" {{ request('payment_method') == 'home_credit' ? 'selected' : '' }}>Home Credit</option>
                            ...
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div>
                                        ...
                                        <div class="text-sm text-gray-500">{{ $sale->items->count() }} item(s)</div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div>
                                        ...
                                        @if($sale->status === 'completed')
                                            ...
                                            <form method="POST" action="{{ route('sales.cancel', $sale) }}" class="inline">
                                                ...
                                                <button type="submit" class="text-red-600 hover:text-red-900" 
                                                        onclick="return confirm('Are you sure you want to cancel this sale? This will restore inventory.')">
                                                    Cancel
                                                </button>
                                            </form>
                                        @endif
